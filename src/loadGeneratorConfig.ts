...
export const CONFIG_FILE_NAME = "registrygen-config.json";
export const DEFAULT_ALLOWED_EXTENSIONS = [".js", ".jsx", ".ts", ".tsx"];
export const DEFAULT_SKIP_DIRECTORIES = ["node_modules", ".git", "dist", ".dist"];
export const DEFAULT_REGISTRY_PREFIX = "@hoogin-";
export const DEFAULT_HOME_PAGE = "https://hoogin.be";
